...
class Metric extends OperatorResource implements Retrievable
{
    ...
    /** @var string */
    public $unit;
    protected $aliases = ['created_by_user_id' => 'createdByUserId', 'created_by_project_id' => 'createdByProjectId', 'archive_policy' => 'archivePolicy'];
    /**
     * {@inheritdoc}
     */
    protected function getAliases()
    {
        return parent::getAliases() + ['resource' => new Alias('resource', Resource::class)];
    }
    /**
     * {@inheritdoc}
     */

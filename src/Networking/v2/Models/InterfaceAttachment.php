...
class InterfaceAttachment extends OperatorResource implements Listable
{
    ...
    protected $aliases = ['port_id' => 'portId', 'net_id' => 'netId', 'mac_addr' => 'macAddr', 'subnet_id' => 'subnetId', 'ip_address' => 'ipAddress', 'fixed_ips' => 'fixedIps', 'port_state' => 'portState', 'server_id' => 'serverId'];
}
...
class Port extends OperatorResource implements Creatable, Updateable, Deletable, Listable, Retrievable
{
    ...
    protected $aliases = ['admin_state_up' => 'adminStateUp', 'display_name' => 'displayName', 'network_id' => 'networkId', 'tenant_id' => 'tenantId', 'device_owner' => 'deviceOwner', 'mac_address' => 'macAddress', 'port_id' => 'portId', 'security_groups' => 'securityGroups', 'device_id' => 'deviceId', 'fixed_ips' => 'fixedIps'];

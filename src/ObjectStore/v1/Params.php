...
class Params extends AbstractParams
{
    ...
    {
        return ['location' => self::QUERY, 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'type' => self::BOOL_TYPE, 'sentAs' => 'X-Newest', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => sprintf('X-%s-Meta-Temp-URL-Key', ucfirst($type)), 'description' => 'The secret key value for temporary URLs.'];
    }
    public function tempUrlKey2($type)
    {
        return ['location' => self::HEADER, 'sentAs' => sprintf('X-%s-Meta-Temp-URL-Key-2', ucfirst($type)), 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::URL, 'required' => true, 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => 'query', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => 'header', 'sentAs' => sprintf('X-%s-Read', ucfirst($type)), 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Container-Sync-To', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Container-Sync-Key', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => sprintf('X-%s-Write', ucfirst($type)), 'description' => 'Like `readAccess` parameter, but for write access.'];
    }
    public function metadata($type, $remove = false)
    {
        ...
        return ['location' => self::HEADER, 'type' => self::OBJECT_TYPE, 'prefix' => sprintf('X-%s-Meta-', ucfirst($type)), 'properties' => ['type' => self::STRING_TYPE], 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Versions-Location', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Container-Meta-Quota-Bytes', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Container-Meta-Quota-Count', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Container-Meta-Web-Directory-Type', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'type' => self::BOOL_TYPE, 'sentAs' => 'X-Detect-Content-Type', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Remove-Versions-Location', 'description' => 'Set to any value to disable versioning.'];
    }
    public function objectName()
    {
        return ['location' => self::URL, 'required' => true, 'description' => 'The unique name for the object'];
    }
    public function range()
    {
        return ['location' => self::HEADER, 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'If-Match', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'If-None-Match', 'description' => <<<EOT
In a nutshell, this provides for conditional requests. The value provided should be a MD5 checksum, and it will be
checked by the server receiving the request. If any existing entity held on the server has the same MD5 checksum (or
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'If-Modified-Since', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'If-Unmodified-Since', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Delete-After', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Delete-At', 'description' => 'The certain date, in UNIX Epoch timestamp format, when the object will be removed.'];
    }
    public function contentEncoding()
    {
        return ['location' => self::HEADER, 'sentAs' => 'Content-Encoding', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'Content-Disposition', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Copy-From', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'ETag', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'sentAs' => 'Content-Type', 'description' => 'The Content-Type entity-header field indicates the media type of the entity-body'];
    }
    public function destination()
    {
        return ['location' => self::HEADER, 'sentAs' => 'Destination', 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::HEADER, 'type' => self::BOOL_TYPE, 'description' => <<<EOT
...
EOT
    ...
    {
        return ['location' => self::RAW, 'type' => self::STRING_TYPE, 'description' => 'The content of the object in string form'];
    }
    public function stream()
    {
        return ['location' => self::RAW, 'type' => StreamInterface::class, 'description' => 'The content of the object in string form'];
    }
    public function format()
    {
        return ['location' => self::QUERY, 'type' => self::STRING_TYPE, 'description' => 'Defines the format of the collection. Will always default to `json`.'];
    }
    public function objectManifest()
    {
        return ['location' => self::HEADER, 'sentAs' => 'X-Object-Manifest', 'type' => self::STRING_TYPE, 'description' => <<<EOT

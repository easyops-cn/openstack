...
class StorageObject extends OperatorResource implements Creatable, Deletable, HasMetadata
{
    ...
    protected $aliases = ['bytes' => 'contentLength', 'content_type' => 'contentType', 'subdir' => 'name'];
    /**
     * {@inheritdoc}
     */
    protected function getAliases()
    {
        return parent::getAliases() + ['last_modified' => new Alias('lastModified', \DateTimeImmutable::class)];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function create(array $data)
    {
        ...
        $storageObject = $storageObject->populateFromArray(['name' => $data['name'], 'containerName' => $data['containerName']]);
    ...
    {
        $options = ['containerName' => $this->containerName, 'name' => $this->name, 'metadata' => array_merge($metadata, $this->getMetadata())];

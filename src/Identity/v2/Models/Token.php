...
class Token extends OperatorResource implements \OpenStack\Common\Auth\Token
{
    ...
    {
        return parent::getAliases() + ['tenant' => new Alias('tenant', Tenant::class), 'expires' => new Alias('expires', \DateTimeImmutable::class), 'issued_at' => new Alias('issuedAt', \DateTimeImmutable::class)];
    }
    /**
     * {@inheritdoc}
     */

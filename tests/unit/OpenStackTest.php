...
class OpenStackTest extends TestCase
{
    ...
    {
        $this->builder->createService('Compute\\v2', ['catalogName' => 'nova', 'catalogType' => 'compute'])->shouldBeCalled()->willReturn($this->service(ComputeServiceV2::class));
    ...
    {
        $this->builder->createService('Identity\\v3', ['catalogName' => 'keystone', 'catalogType' => 'identity'])->shouldBeCalled()->willReturn($this->service(IdentityServiceV3::class));
        $this->openstack->identityV3();
    }
    public function test_it_supports_networking_v2()
    {
        $this->builder->createService('Networking\\v2', ['catalogName' => 'neutron', 'catalogType' => 'network'])->shouldBeCalled()->willReturn($this->service(NetworkingServiceV2::class));
        $this->openstack->networkingV2();
    }
    public function test_it_supports_networking_v2_ext_layer3()
    {
        $this->builder->createService('Networking\\v2\\Extensions\\Layer3', ['catalogName' => 'neutron', 'catalogType' => 'network'])->shouldBeCalled()->willReturn($this->service(NetworkingServiceV2ExtLayer3::class));
        $this->openstack->networkingV2ExtLayer3();
    }
    public function test_it_supports_networking_v2_ext_security_group()
    {
        $this->builder->createService('Networking\\v2\\Extensions\\SecurityGroups', ['catalogName' => 'neutron', 'catalogType' => 'network'])->shouldBeCalled()->willReturn($this->service(NetworkingServiceV2ExtSecGroup::class));
        $this->openstack->networkingV2ExtSecGroups();
    }
    public function test_it_supports_object_store_v1()
    {
        $this->builder->createService('ObjectStore\\v1', ['catalogName' => 'swift', 'catalogType' => 'object-store'])->shouldBeCalled()->willReturn($this->service(ObjectStoreServiceV1::class));
        $this->openstack->objectStoreV1();
    }
    public function test_it_supports_block_storage_v2()
    {
        $this->builder->createService('BlockStorage\\v2', ['catalogName' => 'cinderv2', 'catalogType' => 'volumev2'])->shouldBeCalled()->willReturn($this->service(BlockStorageServiceV2::class));
    ...
    {
        $this->builder->createService('Metric\\v1\\Gnocchi', ['catalogName' => 'gnocchi', 'catalogType' => 'metric'])->shouldBeCalled()->willReturn($this->service(MetricGnocchiV1::class));

...
class ServiceTest extends TestCase
{
    ...
    public function test_it_creates_image()
    {
        ...
        $expectedJson = ["name" => "Ubuntu 12.10", "tags" => ["ubuntu", "quantal"], "container_format" => "bare", "disk_format" => "qcow2", "visibility" => "private", "min_disk" => 0, "protected" => false, "min_ram" => 0];
        $this->setupMock('POST', 'v2/images', $expectedJson, [], 'GET_image');
        $this->service->createImage(['name' => 'Ubuntu 12.10', 'tags' => ['ubuntu', 'quantal'], 'containerFormat' => 'bare', 'diskFormat' => 'qcow2', 'visibility' => 'private', 'minDisk' => 0, 'protected' => false, 'minRam' => 0]);
    }

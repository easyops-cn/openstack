...
class ImageTest extends TestCase
{
    ...
    public function test_it_updates()
    {
        ...
        $opts = ['minDisk' => 1, 'minRam' => 1, 'name' => 'newName', 'owner' => 'bar', 'protected' => true, 'tags' => ['1', '2', '3'], 'visibility' => 'private'];
        $expectedJson = json_encode([(object) ['op' => 'replace', 'path' => '/tags', 'value' => $opts['tags']], (object) ['op' => 'replace', 'path' => '/min_ram', 'value' => $opts['minRam']], (object) ['op' => 'replace', 'path' => '/visibility', 'value' => $opts['visibility']], (object) ['op' => 'replace', 'path' => '/owner', 'value' => $opts['owner']], (object) ['op' => 'replace', 'path' => '/min_disk', 'value' => $opts['minDisk']], (object) ['op' => 'replace', 'path' => '/name', 'value' => $opts['name']], (object) ['op' => 'replace', 'path' => '/protected', 'value' => $opts['protected']]], JSON_UNESCAPED_SLASHES);
        $this->setupMock('GET', $this->path, null, [], 'GET_image');
    ...
    {
        $this->client->request('GET', $this->path . '/members', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('GET_members'));
        $count = 0;

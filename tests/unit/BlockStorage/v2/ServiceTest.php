...
class ServiceTest extends TestCase
{
    ...
    {
        $opts = ["description" => '1', "availabilityZone" => '2', "sourceVolumeId" => '3', "snapshotId" => '4', "size" => 6, "name" => '7', "imageId" => '8', "volumeType" => '9', "metadata" => ['foo' => '1', 'bar' => '2']];
        $expectedJson = ['volume' => ["description" => '1', "availability_zone" => '2', "source_volid" => '3', "snapshot_id" => '4', "size" => 6, "name" => '7', "imageRef" => '8', "volume_type" => '9', "metadata" => ['foo' => '1', 'bar' => '2']]];
    ...
    {
        $this->client->request('GET', 'volumes', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('GET_volumes'));
        $this->client->request('GET', 'volumes', ['query' => ['marker' => '5aa119a8-d25b-45a7-8d1b-88e127885635'], 'headers' => []])->shouldBeCalled()->willReturn(new Response(204));
        $count = 0;
    ...
    {
        $this->client->request('GET', 'types', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('GET_types'));
        $count = 0;
    ...
    {
        $opts = ['name' => 'snap-001', 'description' => 'Daily backup', 'volumeId' => '5aa119a8-d25b-45a7-8d1b-88e127885635', 'force' => true];
        $expectedJson = ['snapshot' => ['name' => $opts['name'], 'description' => $opts['description'], 'volume_id' => $opts['volumeId'], 'force' => $opts['force']]];
    ...
    {
        $this->client->request('GET', 'snapshots', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('GET_snapshots'));
        $this->client->request('GET', 'snapshots', ['query' => ['marker' => 'e820db06-58b5-439d-bac6-c01faa3f6499'], 'headers' => []])->shouldBeCalled()->willReturn(new Response(204));
        $count = 0;
    ...
    {
        $this->client->request('GET', 'os-quota-sets/tenant-id-1234', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('GET_quota_set'));

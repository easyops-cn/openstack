...
class BuilderTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->opts = ['username' => '1', 'password' => '2', 'tenantId' => '3', 'authUrl' => '4', 'region' => '5', 'catalogName' => '6', 'catalogType' => '7'];
    }
    /**
    ...
    {
        $this->builder->createService('Compute\\v2', ['username' => 1, 'password' => 2, 'authUrl' => 4, 'region' => 5, 'catalogName' => 6, 'catalogType' => 7]);
    }
    /**
     * @expectedException \Throwable
     */
    ...
    {
        $this->builder->createService('Compute\\v2', ['username' => 1, 'password' => 2, 'tenantId' => 3, 'authUrl' => 4]);
    }
    /**
     * @expectedException \Throwable
     */
    ...
    {
        $this->builder->createService('Compute\\v2', ['username' => 1, 'password' => 2, 'tenantId' => 3, 'authUrl' => 4, 'region' => 5, 'catalogName' => 6]);
    }
    public function test_it_creates_service()
    {
        ...
        $s = $this->builder->createService('Test\\Common\\Service\\Fixtures', $this->opts + ['identityService' => $is->reveal()]);
    ...
    public function test_it_does_not_authenticate_for_identity_services()
    {
        $is = $this->prophesize(TestIdentity::class);
        $is->authenticate(Argument::any())->willReturn([new FakeToken(), '']);
        $s = $this->builder->createService('Test\\Common\\Service\\Fixtures\\Identity', $this->opts + ['identityService' => $is->reveal()]);
    ...
    public function test_it_create_service_with_micro_version()
    {
        $is = $this->prophesize(TestIdentity::class);
        $is->authenticate(Argument::any())->willReturn([new FakeToken(), '']);
        $s = $this->builder->createService('Test\\Common\\Service\\Fixtures', $this->opts + ['identityService' => $is->reveal(), 'microVersion' => '1.2.3']);
        $this->assertInstanceOf(Fixtures\Service::class, $s);

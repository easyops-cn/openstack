...
class JsonPatchTest extends TestCase
{
    public function testAll()
    {
        ...
        foreach ($fixtures as $fixture) {
            ...
            $this->assertEquals(json_encode($fixture->patch, JSON_UNESCAPED_SLASHES), json_encode($actual, JSON_UNESCAPED_SLASHES), isset($fixture->comment) ? sprintf("Failed asserting test: %s\n", $fixture->comment) : '');
        }
    }
}
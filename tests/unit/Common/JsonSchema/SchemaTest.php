...
class SchemaTest extends TestCase
{
    ...
    {
        $this->validator->getErrors()->shouldBeCalled()->willReturn([['property' => 'foo', 'message' => 'bar']]);
    ...
    {
        $expected = (object) ['foo' => true, 'bar' => false];
        $subject = (object) ['foo' => true, 'bar' => false, 'baz' => true];
        $this->assertEquals((object) $expected, $this->schema->normalizeObject((object) $subject, []));
    }
    public function test_it_stocks_aliases()
    {
        $subject = (object) ['fooAlias' => true, 'bar' => false, 'other' => true];
        $expected = (object) ['foo' => true, 'bar' => false];

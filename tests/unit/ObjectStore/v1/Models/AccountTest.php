...
class AccountTest extends TestCase
{
    ...
    {
        $this->setupMock('HEAD', '', null, [], 'HEAD_Account');
        $headers = ['X-Account-Meta-Book' => 'Middlesex', 'X-Account-Meta-Author' => 'Jeffrey Eugenides', 'X-Remove-Account-Meta-Genre' => 'True'];
        $this->setupMock('POST', '', [], $headers, 'NoContent');
        $this->account->resetMetadata(['Book' => 'Middlesex', 'Author' => 'Jeffrey Eugenides']);
    }
}
...
class ObjectTest extends TestCase
{
    ...
    public function test_It_Creates()
    {
        ...
        $this->object->create(['name' => $objectName, 'content' => $content, 'contentType' => $headers['Content-Type'], 'contentEncoding' => $headers['Content-Encoding'], 'contentDisposition' => $headers['Content-Disposition'], 'deleteAfter' => $headers['X-Delete-After'], 'metadata' => ['Author' => 'foo', 'genre' => 'bar']]);
    }
    ...
    {
        $this->setupMock('HEAD', self::CONTAINER . '/' . self::NAME, null, [], 'HEAD_Object');
        $this->assertEquals(['Book' => 'GoodbyeColumbus', 'Manufacturer' => 'Acme'], $this->object->getMetadata());
    }
    public function test_Merge_Metadata()
    {
        $this->setupMock('HEAD', self::CONTAINER . '/' . self::NAME, null, [], 'HEAD_Object');
        $headers = ['X-Object-Meta-Author' => 'foo', 'X-Object-Meta-Book' => 'GoodbyeColumbus', 'X-Object-Meta-Manufacturer' => 'Acme'];
    ...
    public function test_It_Copies()
    {
        ...
        $this->object->copy(['destination' => $headers['Destination']]);
    }

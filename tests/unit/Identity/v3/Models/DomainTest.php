...
class DomainTest extends TestCase
{
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['description' => 'foo', 'name' => 'bar', 'enabled' => false];
    ...
    {
        $this->client->request('HEAD', 'domains/DOMAIN_ID/users/USER_ID/roles/ROLE_ID', ['headers' => []])->shouldBeCalled()->willThrow(new BadResponseError());
    ...
    {
        $this->client->request('HEAD', 'domains/DOMAIN_ID/groups/GROUP_ID/roles/ROLE_ID', ['headers' => []])->shouldBeCalled()->willThrow(new BadResponseError());

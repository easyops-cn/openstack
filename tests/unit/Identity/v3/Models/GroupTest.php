...
class GroupTest extends TestCase
{
    ...
    {
        $userOptions = ['description' => 'desc', 'domainId' => 'domainId', 'name' => 'name'];
        $userJson = ['description' => $userOptions['description'], 'domain_id' => $userOptions['domainId'], 'name' => $userOptions['name']];
    ...
    {
        $this->client->request('HEAD', 'groups/GROUP_ID/users/USER_ID', ['headers' => []])->shouldBeCalled()->willThrow(new BadResponseError());

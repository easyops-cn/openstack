...
class ProjectTest extends TestCase
{
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['description' => 'desc', 'domain_id' => 'domainId', 'parent_id' => 'parentId', 'enabled' => true, 'name' => 'name'];
    ...
    {
        $this->client->request('HEAD', 'projects/PROJECT_ID/users/USER_ID/roles/ROLE_ID', ['headers' => []])->shouldBeCalled()->willThrow(new BadResponseError());
    ...
    {
        $this->client->request('HEAD', 'projects/PROJECT_ID/groups/GROUP_ID/roles/ROLE_ID', ['headers' => []])->shouldBeCalled()->willThrow(new BadResponseError());

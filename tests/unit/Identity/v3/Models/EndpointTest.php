...
class EndpointTest extends TestCase
{
    ...
    {
        $userOptions = ['interface' => 'admin', 'name' => 'name', 'region' => 'RegionOne', 'url' => 'foo.com', 'serviceId' => '12345'];
    ...
    public function test_it_updates_endpoint()
    {
        ...
        $userJson = ['interface' => 'admin', 'name' => 'name', 'region' => 'RegionOne', 'url' => 'foo.com', 'service_id' => '12345'];

...
class ServiceTest extends TestCase
{
    ...
    {
        $userOptions = ['user' => ['id' => '{userId}', 'password' => '{userPassword}', 'domain' => ['id' => '{domainId}']], 'scope' => ['project' => ['id' => '{projectId}']], 'catalogName' => 'swift', 'catalogType' => 'object-store', 'region' => 'RegionOne'];
        $expectedJson = ["identity" => ["methods" => ["password"], "password" => ["user" => ["id" => "{userId}", "password" => "{userPassword}", 'domain' => ['id' => '{domainId}']]]], "scope" => ["project" => ["id" => "{projectId}"]]];
    ...
    {
        $cachedToken = ['is_domain' => false, 'methods' => ['password'], 'roles' => [0 => ['id' => 'ce40dfb7a1b14f8a875194fe2944e00c', 'name' => 'admin']], 'expires_at' => '2199-11-24T04:47:49.000000Z', 'project' => ['domain' => ['id' => 'default', 'name' => 'Default'], 'id' => 'c41b19de8aac4ecdb0f04ede718206c5', 'name' => 'admin'], 'catalog' => [['endpoints' => [['region_id' => 'RegionOne', 'url' => 'http://example.org:8080/v1/AUTH_e00abf65afca49609eedd163c515cf10', 'region' => 'RegionOne', 'interface' => 'public', 'id' => 'hhh']], 'type' => 'object-store', 'id' => 'aaa', 'name' => 'swift']], 'user' => ['domain' => ['id' => 'default', 'name' => 'Default'], 'id' => '37a36374b074428985165e80c9ab28c8', 'name' => 'admin'], 'audit_ids' => ['X0oY7ouSQ32vEpbgDJTDpA'], 'issued_at' => '2017-11-24T03:47:49.000000Z', 'id' => 'bb4f74cfb73847ec9ca947fa61d799d3'];
        $userOptions = ['user' => ['id' => '{userId}', 'password' => '{userPassword}', 'domain' => ['id' => '{domainId}']], 'scope' => ['project' => ['id' => '{projectId}']], 'catalogName' => 'swift', 'catalogType' => 'object-store', 'region' => 'RegionOne', 'cachedToken' => $cachedToken];
        list($token, $url) = $this->service->authenticate($userOptions);
        $this->assertInstanceOf(Models\Token::class, $token);
        $this->assertEquals('http://example.org:8080/v1/AUTH_e00abf65afca49609eedd163c515cf10', $url);
    }
    ...
    {
        $cachedToken = ['is_domain' => false, 'methods' => ['password'], 'roles' => [0 => ['id' => 'ce40dfb7a1b14f8a875194fe2944e00c', 'name' => 'admin']], 'expires_at' => '2000-11-24T04:47:49.000000Z', 'project' => ['domain' => ['id' => 'default', 'name' => 'Default'], 'id' => 'c41b19de8aac4ecdb0f04ede718206c5', 'name' => 'admin'], 'catalog' => [['endpoints' => [['region_id' => 'RegionOne', 'url' => 'http://example.org:8080/v1/AUTH_e00abf65afca49609eedd163c515cf10', 'region' => 'RegionOne', 'interface' => 'public', 'id' => 'hhh']], 'type' => 'object-store', 'id' => 'aaa', 'name' => 'swift']], 'user' => ['domain' => ['id' => 'default', 'name' => 'Default'], 'id' => '37a36374b074428985165e80c9ab28c8', 'name' => 'admin'], 'audit_ids' => ['X0oY7ouSQ32vEpbgDJTDpA'], 'issued_at' => '2017-11-24T03:47:49.000000Z', 'id' => 'bb4f74cfb73847ec9ca947fa61d799d3'];
        $userOptions = ['user' => ['id' => '{userId}', 'password' => '{userPassword}', 'domain' => ['id' => '{domainId}']], 'scope' => ['project' => ['id' => '{projectId}']], 'catalogName' => 'swift', 'catalogType' => 'object-store', 'region' => 'RegionOne', 'cachedToken' => $cachedToken];
    ...
    public function test_it_throws_exception_if_no_endpoint_found()
    {
        $expectedJson = ["identity" => ["methods" => ["password"], "password" => ["user" => ["id" => "{userId}", "password" => "{userPassword}", 'domain' => ['id' => '{domainId}']]]], "scope" => ["project" => ["id" => "{projectId}"]]];
        $this->setupMock('POST', 'auth/tokens', ['auth' => $expectedJson], [], 'token');
        $this->service->authenticate(['catalogName' => 'foo', 'catalogType' => 'bar', 'region' => 'baz', 'user' => ['id' => '{userId}', 'password' => '{userPassword}', 'domain' => ['id' => '{domainId}']], 'scope' => ['project' => ['id' => '{projectId}']]]);
    }
    public function test_it_gets_token()
    {
        ...
        $user = $this->service->model(Models\User::class, ["domain" => ["id" => "1789d1", "links" => ["self" => "http://identity:35357/v3/domains/1789d1"], "name" => "example.com"], "id" => "0ca8f6", "links" => ["self" => "http://identity:35357/v3/users/0ca8f6"], "name" => "Joe"]);
    ...
    {
        $this->client->request('HEAD', 'auth/tokens', ['headers' => ['X-Subject-Token' => 'tokenId']])->shouldBeCalled()->willThrow(new BadResponseError());
    ...
    {
        $userOptions = ['interface' => Enum::INTERFACE_INTERNAL, 'name' => 'endpointName', 'region' => 'RegionOne', 'url' => 'myopenstack.org:12345/v2.0', 'serviceId' => 'serviceId'];
    ...
    {
        $userOptions = ['description' => 'bar', 'enabled' => true, 'name' => 'foo'];
    ...
    {
        $userOptions = ['defaultProjectId' => 'bar', 'description' => "Jim Doe's user", 'domainId' => 'foo', 'email' => 'baz', 'enabled' => true, 'name' => 'James Doe', 'password' => 'secret'];
    ...
    {
        $userOptions = ['description' => "description", 'name' => 'name'];
    ...
    {
        $userOptions = ['blob' => "{\"access\":\"--access-key--\",\"secret\":\"--secret-key--\"}", 'projectId' => 'project_id', 'type' => 'ec2', 'userId' => 'user_id'];
        $userJson = ['blob' => $userOptions['blob'], 'project_id' => $userOptions['projectId'], 'type' => $userOptions['type'], 'user_id' => $userOptions['userId']];
    ...
    {
        $userOptions = ['blob' => 'blob', 'projectId' => 'project_id', 'type' => 'ec2', 'userId' => 'user_id'];
        $userJson = ['blob' => $userOptions['blob'], 'project_id' => $userOptions['projectId'], 'type' => $userOptions['type'], 'user_id' => $userOptions['userId']];
    ...
    {
        $userOptions = ['user' => ['id' => '{userId}', 'password' => '{userPassword}', 'domain' => ['id' => '{domainId}']], 'scope' => ['project' => ['id' => '{projectId}']]];
        $expectedJson = ["identity" => ["methods" => ["password"], "password" => ["user" => ["id" => "{userId}", "password" => "{userPassword}", 'domain' => ['id' => '{domainId}']]]], "scope" => ["project" => ["id" => "{projectId}"]]];
        $this->setupMock('POST', 'auth/tokens', ['auth' => $expectedJson], [], 'token');
    ...
    {
        $userOptions = ['tokenId' => '{tokenId}', 'scope' => ['project' => ['id' => '{projectId}']]];
        $expectedJson = ["identity" => ["token" => ['id' => '{tokenId}'], 'methods' => ['token']], "scope" => ["project" => ["id" => "{projectId}"]]];
        $this->setupMock('POST', 'auth/tokens', ['auth' => $expectedJson], [], 'token');
        $token = $this->service->generateToken($userOptions);
        $this->assertInstanceOf(Models\Token::class, $token);
    }
    ...
    {
        $cache = ['id' => 'some-token-id'];
        $this->client->request('POST', 'auth/tokens', Argument::any())->shouldNotBeCalled()->willReturn($this->getFixture('token-get'));

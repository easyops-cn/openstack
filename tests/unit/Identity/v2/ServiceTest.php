...
class ServiceTest extends TestCase
{
    ...
    {
        $options = ['username' => 'foo', 'password' => 'bar', 'tenantId' => 'baz', 'catalogName' => 'nova', 'catalogType' => 'compute', 'region' => 'RegionOne', 'urlType' => 'publicUrl'];
        $expectedJson = ['auth' => ['passwordCredentials' => ['username' => $options['username'], 'password' => $options['password']], 'tenantId' => $options['tenantId']]];
    ...
    {
        $options = ['username' => 'foo', 'password' => 'bar', 'tenantId' => 'baz'];
        $expectedJson = ['auth' => ['passwordCredentials' => ['username' => $options['username'], 'password' => $options['password']], 'tenantId' => $options['tenantId']]];
        $this->setupMock('POST', 'tokens', $expectedJson, [], 'token-post');

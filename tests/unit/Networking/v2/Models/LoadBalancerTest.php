...
class LoadBalancerTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'loadbalancer1', 'description' => 'simple lb', 'tenantId' => 'b7c1a69e88bf4b21a8148f787aef2081', 'vipSubnetId' => '013d3059-87a4-45a5-91e9-d721068ae0b2', 'vipAddress' => '10.0.0.4', 'adminStateUp' => true];
        $expectedJson = ['loadbalancer' => ['name' => $opts['name'], 'description' => $opts['description'], 'tenant_id' => $opts['tenantId'], 'vip_subnet_id' => $opts['vipSubnetId'], 'vip_address' => $opts['vipAddress'], 'admin_state_up' => $opts['adminStateUp']]];
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['loadbalancer' => ['name' => 'foo', 'description' => 'bar']];
    ...
    {
        $opts = ['name' => 'listener1', 'description' => 'simple listener', 'tenantId' => 'tenantId', 'protocol' => 'HTTP', 'protocolPort' => 443, 'connectionLimit' => 1000, 'adminStateUp' => true];
        $expectedJson = ['listener' => ['name' => $opts['name'], 'description' => $opts['description'], 'tenant_id' => $opts['tenantId'], 'protocol' => $opts['protocol'], 'protocol_port' => $opts['protocolPort'], 'connection_limit' => $opts['connectionLimit'], 'admin_state_up' => $opts['adminStateUp'], 'loadbalancer_id' => 'loadbalancerId']];

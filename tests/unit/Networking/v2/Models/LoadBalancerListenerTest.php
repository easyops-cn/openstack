...
class LoadBalancerListenerTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'listener1', 'description' => 'simple listener', 'tenantId' => 'b7c1a69e88bf4b21a8148f787aef2081', 'protocol' => 'HTTP', 'protocolPort' => 443, 'connectionLimit' => 1000, 'adminStateUp' => true];
        $expectedJson = ['listener' => ['name' => $opts['name'], 'description' => $opts['description'], 'tenant_id' => $opts['tenantId'], 'protocol' => $opts['protocol'], 'protocol_port' => $opts['protocolPort'], 'admin_state_up' => $opts['adminStateUp'], 'connection_limit' => $opts['connectionLimit']]];
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['listener' => ['name' => 'foo', 'description' => 'bar', 'connection_limit' => 999, 'admin_state_up' => false]];

...
class LoadBalancerMemberTest extends TestCase
{
    ...
    {
        $opts = ['address' => '127.0.0.1', 'protocolPort' => 443, 'weight' => 42, 'subnetId' => 'subnetId', 'adminStateUp' => true];
        $expectedJson = ['member' => ['address' => $opts['address'], 'protocol_port' => $opts['protocolPort'], 'weight' => $opts['weight'], 'subnet_id' => $opts['subnetId'], 'admin_state_up' => $opts['adminStateUp']]];
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['member' => ['weight' => 154, 'admin_state_up' => false]];

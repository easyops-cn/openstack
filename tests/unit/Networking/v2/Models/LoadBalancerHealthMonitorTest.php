...
class LoadBalancerHealthMonitorTest extends TestCase
{
    ...
    public function test_it_creates()
    {
        ...
        $expectedJson = ['healthmonitor' => ['admin_state_up' => $opts['adminStateUp'], 'tenant_id' => $opts['tenantId'], 'delay' => $opts['delay'], 'type' => $opts['type'], 'expected_codes' => $opts['expectedCodes'], 'max_retries' => $opts['maxRetries'], 'http_method' => $opts['httpMethod'], 'url_path' => $opts['urlPath'], 'timeout' => $opts['timeout']]];
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['healthmonitor' => ['delay' => 48, 'timeout' => 54, 'max_retries' => 11, 'http_method' => 'POST', 'url_path' => 'test2', 'expected_codes' => '200,201,202', 'admin_state_up' => true]];

...
class SubnetTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'foo', 'networkId' => 'networkId', 'tenantId' => 'tenantId', 'ipVersion' => 4, 'cidr' => '192.168.199.0/24', 'enableDhcp' => false];
        $expectedJson = json_encode(['subnet' => ['name' => $opts['name'], 'network_id' => $opts['networkId'], 'tenant_id' => $opts['tenantId'], 'ip_version' => $opts['ipVersion'], 'cidr' => $opts['cidr'], 'enable_dhcp' => $opts['enableDhcp']]], JSON_UNESCAPED_SLASHES);
    ...
    public function test_it_updates()
    {
        ...
        $expectedJson = ['subnet' => ['name' => $this->subnet->name, 'gateway_ip' => $this->subnet->gatewayIp]];

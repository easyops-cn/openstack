...
class PortTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'newName', 'networkId' => self::NETWORK_ID, 'adminStateUp' => false];
    ...
    {
        $opts = ['networkId' => self::NETWORK_ID, 'fixedIps' => [['ipAddress' => '192.168.254.20', 'subnetId' => 'd8e52c33-b301-4feb-9856-a71b71f06c1d']]];
        $expectedJson = ['port' => ['network_id' => self::NETWORK_ID, 'fixed_ips' => [['ip_address' => '192.168.254.20', 'subnet_id' => 'd8e52c33-b301-4feb-9856-a71b71f06c1d']]]];

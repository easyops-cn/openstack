...
class ServiceTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'foo', 'shared' => false, 'adminStateUp' => true];
        $expectedJson = ['network' => ['name' => $opts['name'], 'shared' => $opts['shared'], 'admin_state_up' => $opts['adminStateUp']]];
    ...
    {
        $opts = [['name' => 'foo', 'shared' => false, 'adminStateUp' => true], ['name' => 'bar', 'shared' => true, 'adminStateUp' => false]];
        $expectedJson = ['networks' => [['name' => $opts[0]['name'], 'shared' => $opts[0]['shared'], 'admin_state_up' => $opts[0]['adminStateUp']], ['name' => $opts[1]['name'], 'shared' => $opts[1]['shared'], 'admin_state_up' => $opts[1]['adminStateUp']]]];
    ...
    {
        $this->client->request('GET', 'v2.0/networks', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('networks-post'));
    ...
    {
        $opts = ['name' => 'foo', 'networkId' => 'networkId', 'tenantId' => 'tenantId', 'ipVersion' => 4, 'cidr' => '192.168.199.0/24'];
        $expectedJson = json_encode(['subnet' => ['name' => $opts['name'], 'network_id' => $opts['networkId'], 'tenant_id' => $opts['tenantId'], 'ip_version' => $opts['ipVersion'], 'cidr' => $opts['cidr']]], JSON_UNESCAPED_SLASHES);
    ...
    {
        $opts = [['name' => 'foo', 'networkId' => 'networkId', 'tenantId' => 'tenantId', 'ipVersion' => 4, 'cidr' => '192.168.199.0/24'], ['name' => 'bar', 'networkId' => 'networkId', 'tenantId' => 'tenantId', 'ipVersion' => 4, 'cidr' => '10.56.4.0/22']];
        $expectedJson = json_encode(['subnets' => [['name' => $opts[0]['name'], 'network_id' => $opts[0]['networkId'], 'tenant_id' => $opts[0]['tenantId'], 'ip_version' => $opts[0]['ipVersion'], 'cidr' => $opts[0]['cidr']], ['name' => $opts[1]['name'], 'network_id' => $opts[1]['networkId'], 'tenant_id' => $opts[1]['tenantId'], 'ip_version' => $opts[1]['ipVersion'], 'cidr' => $opts[1]['cidr']]]], JSON_UNESCAPED_SLASHES);
    ...
    {
        $this->client->request('GET', 'v2.0/subnets', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('subnets-post'));
    ...
    {
        $opts = ['name' => 'private-port', 'networkId' => 'a87cc70a-3e15-4acf-8205-9b711a3531b7', 'adminStateUp' => true];
        $expectedJson = ['port' => ['name' => $opts['name'], 'network_id' => $opts['networkId'], 'admin_state_up' => $opts['adminStateUp']]];
    ...
    {
        $opts = [['name' => 'private-port1', 'networkId' => 'a87cc70a-3e15-4acf-8205-9b711a3531b7', 'adminStateUp' => true], ['name' => 'private-port2', 'networkId' => 'a87cc70a-3e15-4acf-8205-9b711a3531b7', 'adminStateUp' => true]];
        $expectedJson = ['ports' => [['name' => $opts[0]['name'], 'network_id' => $opts[0]['networkId'], 'admin_state_up' => $opts[0]['adminStateUp']], ['name' => $opts[1]['name'], 'network_id' => $opts[1]['networkId'], 'admin_state_up' => $opts[1]['adminStateUp']]]];
    ...
    {
        $this->client->request('GET', 'v2.0/ports', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('ports_get'));
    ...
    {
        $this->client->request('GET', 'v2.0/quotas', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('quotas-get'));
    ...
    {
        $this->client->request('GET', 'v2.0/quotas/fake_tenant_id', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('quota-get'));
    ...
    {
        $this->client->request('GET', 'v2.0/quotas/fake_tenant_id/default', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('quota-get'));

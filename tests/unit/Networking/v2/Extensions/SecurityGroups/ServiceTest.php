...
class ServiceTest extends TestCase
{
    ...
    {
        $this->client->request('GET', 'v2.0/security-groups', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('SecurityGroups'));
    ...
    {
        $options = ['name' => 'new-webservers', 'description' => 'security group for webservers'];
    ...
    {
        $this->client->request('GET', 'v2.0/security-group-rules', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('SecurityGroupRules'));
    ...
    {
        $options = ["direction" => "ingress", "portRangeMin" => "80", "ethertype" => "IPv4", "portRangeMax" => "80", "protocol" => "tcp", "remoteGroupId" => "85cc3048-abc3-43cc-89b3-377341426ac5", "securityGroupId" => "a7734e61-b545-452d-a3cd-0189cbd9747a"];
        $expectedJson = ['security_group_rule' => ["direction" => "ingress", "port_range_min" => "80", "ethertype" => "IPv4", "port_range_max" => "80", "protocol" => "tcp", "remote_group_id" => "85cc3048-abc3-43cc-89b3-377341426ac5", "security_group_id" => "a7734e61-b545-452d-a3cd-0189cbd9747a"]];

...
class ServiceTest extends TestCase
{
    ...
    {
        $opts = ['name' => 'foo', 'imageId' => '', 'flavorId' => ''];
        $expectedJson = ['server' => ['name' => $opts['name'], 'imageRef' => $opts['imageId'], 'flavorRef' => $opts['flavorId']]];
    ...
    {
        $this->client->request('GET', 'servers', ['query' => ['limit' => 5], 'headers' => []])->shouldBeCalled()->willReturn($this->getFixture('servers-get'));
    ...
    {
        $server = $this->service->getServer(['id' => 'serverId']);
        $this->assertInstanceOf(Server::class, $server);
        $this->assertEquals('serverId', $server->id);
    }
    public function test_it_lists_flavors()
    {
        $this->client->request('GET', 'flavors', ['query' => ['limit' => 5], 'headers' => []])->shouldBeCalled()->willReturn($this->getFixture('flavors-get'));
        $count = 0;
    ...
    {
        $flavor = $this->service->getFlavor(['id' => 'flavorId']);
        $this->assertInstanceOf(Flavor::class, $flavor);
        $this->assertEquals('flavorId', $flavor->id);
    }
    public function test_it_lists_images()
    {
        $this->client->request('GET', 'images', ['query' => ['limit' => 5], 'headers' => []])->shouldBeCalled()->willReturn($this->getFixture('images-get'));
    ...
    {
        $image = $this->service->getImage(['id' => 'imageId']);
        $this->assertInstanceOf(Image::class, $image);
        $this->assertEquals('imageId', $image->id);
    }
    public function test_it_lists_keypairs()
    {
        $this->client->request('GET', 'os-keypairs', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('keypairs-get'));
    ...
    {
        $this->client->request('GET', 'os-hypervisors/statistics', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('hypervisor-statistic-get'));
    ...
    {
        $this->client->request('GET', 'os-hypervisors', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('hypervisors-get'));
    ...
    {
        $this->client->request('GET', 'os-hypervisors/1234', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('hypervisor-get'));
    ...
    {
        $this->client->request('GET', 'os-hosts', ['query' => ['limit' => 5], 'headers' => []])->shouldBeCalled()->willReturn($this->getFixture('hosts-get'));
    ...
    {
        $this->client->request('GET', 'os-hosts/b6e4adbc193d428ea923899d07fb001e', ['headers' => []])->shouldBeCalled()->willReturn($this->getFixture('host-get'));
    ...
    {
        $this->client->request('GET', 'os-availability-zone/detail', ['query' => ['limit' => 5], 'headers' => []])->shouldBeCalled()->willReturn($this->getFixture('availability-zones-get'));

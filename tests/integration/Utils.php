...
class Utils
{
    ...
    {
        return ['authUrl' => getenv('OS_AUTH_URL'), 'region' => getenv('OS_REGION_NAME'), 'user' => ['id' => getenv('OS_USER_ID'), 'password' => getenv('OS_PASSWORD')], 'scope' => ['project' => ['id' => getenv('OS_PROJECT_ID')]]];
    }
    ...
    {
        $authOptions = getenv('OS_IDENTITY_API_VERSION') == '2.0' ? self::getAuthOptsV2() : self::getAuthOptsV3();

...
class CoreTest extends TestCase
{
    ...
    {
        $replacements = ['{name}' => $this->randomStr(), '{description}' => $this->randomStr()];
    ...
    public function endpoints()
    {
        ...
        $replacements = ['{endpointName}' => $this->randomStr(), '{serviceId}' => $service->id, '{endpointUrl}' => getenv('OS_AUTH_URL'), '{region}' => 'RegionOne'];
    ...
    {
        $replacements = ['{serviceName}' => $this->randomStr(), '{serviceType}' => $this->randomStr()];
    ...
    public function users()
    {
        ...
        $replacements = ['{defaultProjectId}' => $parentProject->id, '{description}' => $this->randomStr(), '{domainId}' => $parentDomain->id, '{email}' => 'foo@bar.com', '{enabled}' => true, '{name}' => $this->randomStr(), '{userPass}' => $this->randomStr()];

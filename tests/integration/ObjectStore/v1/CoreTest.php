...
class CoreTest extends TestCase
{
    ...
    public function accountMetadata()
    {
        ...
        $replacements = ['{key_1}' => 'Foo', '{key_2}' => 'Bar', '{val_1}' => $this->randomStr(), '{val_2}' => $this->randomStr()];
        ...
        $this->assertArraySubset(['Foo' => $replacements['{val_1}'], 'Bar' => $replacements['{val_2}']], $metadata);
        $this->logStep('Resetting account metadata');
        $replacements = ['{key_1}' => 'Foo1', '{key_2}' => 'Bar1', '{val_1}' => $this->randomStr(), '{val_2}' => $this->randomStr()];
        ...
        /** @var array $metadata */
        require_once $this->sampleFile($replacements, 'account/get_metadata.php');
        $this->assertEquals(['Foo1' => $replacements['{val_1}'], 'Bar1' => $replacements['{val_2}']], $metadata);
    }
    public function containers()
    {
        ...
        $this->assertEquals(['Foo' => $replacements['{val_1}'], 'Bar' => $replacements['{val_2}']], $metadata);

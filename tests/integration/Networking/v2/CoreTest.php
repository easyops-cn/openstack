...
class CoreTest extends TestCase
{
    ...
    {
        $replacements = ['{networkName1}' => $this->randomStr(), '{networkName2}' => $this->randomStr()];
        /** @var $networks array */
    ...
    {
        $replacements = ['{networkName}' => $this->randomStr()];
    ...
    {
        $name = $this->randomStr();
        $replacements = ['{networkId}' => $networkId, '{newName}' => $name];
        /** @var $network \OpenStack\Networking\v2\Models\Network */
    ...
    private function createSubnetsAndDelete()
    {
        ...
        require_once $path;
        $replacements = ['{subnetName1}' => $this->randomStr(), '{subnetName2}' => $this->randomStr(), '{networkId1}' => $network->id, '{networkId2}' => $network->id];
        /** @var $subnets array */
    ...
    private function createSubnet()
    {
        ...
        $path = $this->sampleFile(['{newName}' => $this->randomStr()], 'networks/create.php');
        require_once $path;
        $replacements = ['{subnetName}' => $this->randomStr(), '{networkId}' => $network->id];
    ...
    {
        $name = $this->randomStr();
        $replacements = ['{subnetId}' => $subnetId, '{newName}' => $name];
        /** @var $subnet \OpenStack\Networking\v2\Models\Subnet */

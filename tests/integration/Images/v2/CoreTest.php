...
class CoreTest extends TestCase
{
    ...
    {
        $replacements = ['{name}' => 'Ubuntu 12.10', '{tag1}' => 'ubuntu', '{tag2}' => 'quantal', '{containerFormat}' => 'bare', '{diskFormat}' => 'qcow2', '{visibility}' => 'private'];
        ...
        $this->assertInstanceOf(Image::class, $image);
        $replacements += ['{name}' => 'newName', '{visibility}' => 'private'];
    ...
    {
        $replacements = ['{name}' => 'Ubuntu 12.10', '{tag1}' => 'ubuntu', '{tag2}' => 'quantal', '{containerFormat}' => 'bare', '{diskFormat}' => 'qcow2', '{visibility}' => 'private', 'true' => 'false'];
        $this->logStep('Creating image');
        /** @var Image $image */
        require_once $this->sampleFile($replacements, 'images/create.php');
        $replacements = ['{imageId}' => $image->id];
